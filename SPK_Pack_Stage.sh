...
mkdir -p ${package_dir}
cp -a ui ${package_dir}
cp -a ~/Dokumente/Develop/synology.dev/webmin/working/etc ${package_dir}
cp -a ~/Dokumente/Develop/synology.dev/webmin/working/man ${package_dir}
cp -a ~/Dokumente/Develop/synology.dev/webmin/working/reset ${package_dir}
cp -a ~/Dokumente/Develop/synology.dev/webmin/working/scripts ${package_dir}
cp -a ~/Dokumente/Develop/synology.dev/webmin/working/update ${package_dir}
# cp -a ~/Dokumente/Develop/synology.dev/webmin/working/app ${package_dir}
